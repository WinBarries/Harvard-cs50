...
int main()
{
    ...
    bolaClock.setTime(10, 8, 15);

    cout << "Line 2: myClock: ";                       //Line 2
    myClock.printTime();  //print the time of myClock    Line 3
    cout << endl;

    cout << "bola's Line 2: myClock: ";                       //Line 2
    bolaClock.printTime();  //print the time of myClock    Line 3
    cout << endl;
    ...
    cout << "tito's Line 2: myClock: ";                       //Line 2
    titoClock.printTime();  //print the time of myClock    Line 3
    cout << endl;

        //Set the time of yourClock
    yourClock.setTime(5, 45, 16);                      //Line 8
    titoClock.setTime(10, 25, 4);

    cout << "Line 9: After setting, yourClock: ";      //Line 9
    yourClock.printTime(); //print the time of yourClock Line 10
    cout << endl;                                      //Line 11

    cout << "tito's Line 9: After setting, yourClock: ";      //Line 9
    titoClock.printTime(); //print the time of yourClock Line 10
    cout << endl;
    ...
    if (bolaClock.equalTime(titoClock))                  //Line 12
        cout << "Bolatito Line 13: Both times are equal."
             << endl;                                  //Line 13
    else                                               //Line 14
        cout << "Bolatito Line 15: The two times are not equal."
             << endl;                                  //Line 15

    cout << "Bolatito Line 16: Enter the hours, minutes, and "
         << "seconds: ";                               //Line 16
    cin >> hours >> minutes >> seconds;                //Line 17
    cout << endl;
    ...
    bolaClock.setTime(hours, minutes, seconds);
    ...
    cout << "Line 20: New myClock: ";                  //Line 20
    bolaClock.printTime();   //print the time of myClock   Line 21
    cout << endl;

        //Increment the time of myClock by one second
    myClock.incrementSeconds();                        //Line 23
    bolaClock.incrementSeconds();
    ...
    cout << "Line 24: After incrementing myClock by "
         << "one second, myClock: ";                   //Line 24
    bolaClock.printTime();   //print the time of myClock   Line 25
    cout << endl;
    ...
    bolaClock.getTime(hours, minutes, seconds);
